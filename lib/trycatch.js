...
module.exports.generateShim = generateShim;
...
function wrapFunction(func, func_name_prefix) {
	...
	var new_func = function() {
		...
		if (typeof arguments[i] === 'function') {
			if (func_name_prefix == null) {
				arguments[i] = generateShim(arguments[i], func.name);
			} else {
				arguments[i] = generateShim(
					arguments[i],
					func_name_prefix + func.name
				);
			}
		}
